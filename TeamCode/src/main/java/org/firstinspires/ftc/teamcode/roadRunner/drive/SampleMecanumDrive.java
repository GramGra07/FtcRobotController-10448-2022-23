...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        rightFront.setDirection(DcMotor.Direction.REVERSE);//setting the motorFrontRight direction
        rightRear.setDirection(DcMotor.Direction.REVERSE);//setting the motorBackRight direction
