...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftFront = hardwareMap.get(DcMotorEx.class, "motorFrontLeft");
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "motorBackLeft");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "motorBackRight");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "motorFrontRight");
